...
?>
    ...
    <body>
        ...
        // Fetching data 
        $subject_query = "SELECT * FROM tblsubjects WHERE SubjectID = '$id'";
        $subject_result = mysqli_query($connection, $subject_query);
        $row = mysqli_fetch_array($subject_result);
        ...
        <div class="formContainer-flexbox">
            <form action="modify_successful.php" method="post">
                <input type="text" name="subID" value=<?php echo $id; ?> hidden>
                <input type="text" name="subName" value="<?php echo $row[1] ?>" required>
